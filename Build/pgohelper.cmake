...
foreach(video IN LISTS videofiles)
    ...
    SET(ENCODING_COMMAND ${SvtAv1EncApp} -i ${video} -b "${BUILD_DIRECTORY}/${videoname}.ivf" --preset 3 --film-grain 8 --rc 1 --tbr 4200 --max-qp 33 --enable-variance-boost 1 --variance-boost-strength 3 --variance-octile 4 --enable-qm 1 --luminance-qp-bias 10 --sharpness 2 --complex-hvs 1 --psy-rd 1.2 --spy-rd 2 --enable-tf 2 --scd 1 --noise-norm-strength 2 --enable-dlf 2 --qp-scale-compress-strength 2 --lookahead 96 --enable-overlays 1 --tune 0)
